...
<t:BasePage>
    <jsp:attribute name="title">
        <fmt:message key="MENU_REPORTS_AGE_STAT" />
    </jsp:attribute>
    ...
    <jsp:body>
        ...
        <script type="text/javascript">
            function generateReport() {
                var w = window.open(Global.APP_ROOT + "/ws/" + Global.LANG + "/report/ccrobyageandgender", 'CcroByAgeAndGender', 'left=10,top=10,resizable=yes,scrollbars=yes,toolbar=no,titlebar=no,menubar=no,status=no,replace=true');
                if (window.focus) {
                    w.focus();
                }
            }
